...
function edit_task(task_id) {
    ...
    let save_tag = "<button id='save+" + task_id + "'>Save</bbutton>";
    ...
    td_description.innerHTML = "<input id='input_description_" + task_id + "' type='text' value='" + td.description.innerHTML + "'>";

    let td_status = children[2];
    let status_id = "#selected_status_" + task_id;
